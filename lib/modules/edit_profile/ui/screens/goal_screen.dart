...
class GoalScreen extends StatefulWidget {
  final void Function(String selectedGoal)? onSelected;

  const GoalScreen({super.key, this.onSelected});

  @override
  State<GoalScreen> createState() => _GoalScreenState();
}

class _GoalScreenState extends BaseStatefulWidgetState<GoalScreen> {
