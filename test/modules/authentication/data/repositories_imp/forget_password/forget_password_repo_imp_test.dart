...
void main() {
  group('test ForgetPasswordRepoImpl', () {
    ...
    setUp(() {
      ...
      forgetPasswordRepoImpl = ForgetPasswordRepoImpl(forgetPasswordRemoteDataSource);
    });
    test('when forgetPassword it should call forgetPassword from datasource', () async {
    ...
    test('when resetPassword it should call resetPassword from datasource', () async {
      ...
      verify(forgetPasswordRemoteDataSource.resetPassword(email, code,)).called(1);
      expect(actual, equals(result));
    });
